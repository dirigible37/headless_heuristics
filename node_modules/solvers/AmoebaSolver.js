		...
		this.step = function() {
			...
			if(score0 < scoreRef && scoreRef < scoreN) { 
				...
				if(scoreRef < score0) { 
					...
					b = true;
					//if(scoreRef >= Problem.getScore(simplex[n-1])) {
						//if it got here scoreRef > scoreN-1
						//THIS MADE NO SENSE, IF IT'S SORTERD AND scoreRef > scoreN, it's obviously greater than scoreN-1
					...
					//if(Problem.getScore(contraction) <= scoreRef) {
